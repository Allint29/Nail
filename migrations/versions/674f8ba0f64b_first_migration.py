...
Revision ID: 674f8ba0f64b
Revises: 
Create Date: 2019-11-13 14:48:25.332548
...
def upgrade():
    ...
    sa.Column('mail_of_client', sa.String(), nullable=True),
    sa.Column('phone_of_client', sa.String(), nullable=True),
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('adress_accaunt', sa.Integer(), nullable=True),
